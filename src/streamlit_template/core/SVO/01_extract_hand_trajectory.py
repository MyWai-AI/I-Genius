...
from _paper_config import DEPTH_PATH, HAND_MODEL_PATH, HANDS_PATH, PLOTS_PATH, RGB_PATH, ensure_output_dirs, intrinsics_path
from _paper_utils import load_intrinsics, median_valid_depth, save_plot_xyz, stable_hand_bbox_center, to_camera_xyz
        ...
        for fname in tqdm(rgb_files, desc='Hand detection'):
            ...
            if result.hand_landmarks:
                ...
                if z is None:
                    ...
                    center_xyz = np.median(valid_tip_xyz, axis=0).astype(np.float32) if valid_tip_xyz.size else None
                else:
