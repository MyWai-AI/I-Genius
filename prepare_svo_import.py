...
def generate_import_zip(svo_dir, output_zip="trajectory_import.zip", serial_number="VILMA_ROBOT_01", camera_sensor_name="CAMERA1"):
...
if __name__ == "__main__":
    ...
    generate_import_zip(args.svo_dir, args.output, args.serial, args.camera_sensor)
